...
knitr::opts_knit$set(root.dir = normalizePath("/Volumes/GoogleDrive/My Drive/20180528 Deported Veterans Study/SF-36/Data"))
...
data <- read_excel("20190113_36ItemShortFormSurveyInstrument(SF-36)_Responses_Consolidated.xlsx")
...
Use [scale scores standardized from the general US population](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3582698/) to calculate Physical Composite Score (PCS) and Mental Composite Score (MCS).
```{r compScore}
